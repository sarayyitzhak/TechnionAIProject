...
class DevClientMainScreen(Screen):
    ...
    def build_buttons(self):
        ...
        self.build_button("Parse Data", self.on_parse_data_button_clicked, 2, 0, 4)
        self.build_button("Create Production Data Config", self.on_data_config_button_clicked, 3, 0, 4)
        self.build_button("Find Hyper Params", self.on_find_hyper_params_button_clicked, 4, 0, 4)
        self.build_button("Run Algorithm", self.on_run_alg_button_clicked, 5, 0, 4)
    ...
    def on_find_hyper_params_button_clicked(self):
